...
describe('foodApi', () => {
  ...
  describe('Menu Templates', () => {
    it('should fetch templates', async () => {
      ...
      vi.mocked(apiClient.get).mockResolvedValue({ data: { results: mockTemplates } });
    ...
    it('should create template', async () => {
      ...
      expect(apiClient.post).toHaveBeenCalledWith('/food/templates/', { name: 'New Template' });
    ...
    it('should update template', async () => {
      ...
      expect(apiClient.patch).toHaveBeenCalledWith('/food/templates/1/', { name: 'Updated' });
      expect(result).toEqual(mockTemplate);
    });
  ...
  describe('Food Tickets', () => {
    it('should fetch available tickets', async () => {
      ...
      expect(apiClient.get).toHaveBeenCalledWith('/food/tickets/', { params: {} });
    ...
    it('should create ticket', async () => {
      ...
      expect(apiClient.post).toHaveBeenCalledWith('/food/tickets/', expect.any(Object));
  ...
  describe('Default Cooking Days', () => {
    ...
    it('should update default cooking days', async () => {
      ...
      expect(apiClient.put).toHaveBeenCalledWith('/food/default-cooking-days/', {
