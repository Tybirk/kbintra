...
urlpatterns = [
    ...
    path("subgroups/<slug:slug>/join/", SubgroupJoinView.as_view(), name="subgroup-join"),
    path("subgroups/<slug:slug>/leave/", SubgroupLeaveView.as_view(), name="subgroup-leave"),
    path("subgroups/<slug:slug>/update/", SubgroupUpdateView.as_view(), name="subgroup-update"),
    path(
        "subgroups/<slug:slug>/group-chat/",
        SubgroupGroupChatView.as_view(),
        name="subgroup-group-chat",
    ),
    path(
